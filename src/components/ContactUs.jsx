...
const ContactUs = () => {
    ...
    formData.append("access_key", "e48042ca-a37d-441d-8724-867f87211ed4");
       ...
       <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full '>
        ...
        <div>
            ...
            <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
                ...
                <input name="email" type="email" placeholder='Enter your name'className='w-full p-3 text-sm outline-none' required/>
            </div>
